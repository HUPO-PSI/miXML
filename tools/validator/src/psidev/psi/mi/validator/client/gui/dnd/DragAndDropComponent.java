package psidev.psi.mi.validator.client.gui.dnd;
...
public class DragAndDropComponent {
    ...
    /**
     * Constructs a {@link DragAndDropComponent} with a default light-blue border and, if <var>c</var> is a {@link
     * java.awt.Container}, recursively sets all elements contained within as drop targets, though only the top level
    ...
    public DragAndDropComponent(
            ...
            final FilesDroppedListener listener ) {
     ...
     * drops, though only the parent will change borders. With Debugging turned on, more status messages will be
     * displayed to <tt>out</tt>. A common way to use this constructor is with <tt>System.out</tt> or
     * <tt>System.err</tt>. A <tt>null</tt> value for the parameter <tt>out</tt> will result in no debugging output.
     *
     * @param out       PrintStream to record debugging info or null for no debugging.
     * @param c         Component on which files will be dropped.
    ...
    /**
     * Full constructor with a specified border and debugging optionally turned on. With Debugging turned on, more
     * status messages will be displayed to <tt>out</tt>. A common way to use this constructor is with
     * <tt>System.out</tt> or <tt>System.err</tt>. A <tt>null</tt> value for the parameter <tt>out</tt> will result in
     * no debugging output.
     *
     * @param out        PrintStream to record debugging info or null for no debugging.
     * @param c          Component on which files will be dropped.
